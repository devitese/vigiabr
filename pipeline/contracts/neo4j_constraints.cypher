// VigiaBR — Neo4j Constraints & Indexes (contract)
// Actual constraint scripts live in pipeline/schemas/neo4j/
...
CREATE CONSTRAINT votacao_id IF NOT EXISTS FOR (v:Votacao) REQUIRE v.id_externo IS UNIQUE;
...
// Node key constraints for BemPatrimonial (no single unique field)
